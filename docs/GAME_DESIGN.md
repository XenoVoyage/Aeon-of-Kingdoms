...
> **Prototype-era document:** everything below describes the rejected `v2026.8.15` direction as frozen history. Do not extend or implement its prescriptive language during the redesign. [`REDESIGN.md`](REDESIGN.md) is the active roadmap; [`PHASE1B_VISUAL_LOCK.md`](PHASE1B_VISUAL_LOCK.md) owns the approved visual/interaction target, [`PHASE2_FOUNDATION.md`](PHASE2_FOUNDATION.md) owns the approved landscape foundation, [`PHASE3_ENTITY_MOVEMENT.md`](PHASE3_ENTITY_MOVEMENT.md) owns the approved entity/movement rules, [`PHASE4_STRUCTURES_ECONOMY.md`](PHASE4_STRUCTURES_ECONOMY.md) owns the approved structures/economy foundation, [`PHASE5_COMBAT_TACTICS.md`](PHASE5_COMBAT_TACTICS.md) owns the closed combat/tactical-command foundation, [`PHASE6_STRATEGIC_AI.md`](PHASE6_STRATEGIC_AI.md) owns the closed strategic-AI/local-skirmish foundation, and [`PHASE7_PRODUCT_HARDENING.md`](PHASE7_PRODUCT_HARDENING.md) owns the active product-hardening contract. This historical design is not a source for replacement tuning or scope.
