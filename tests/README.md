...
3. Run `node .github/scripts/stage-pages.js _site` and verify the exact 73-file stage: `.nojekyll` plus 72 explicitly allowlisted files comprising the status shell; public status/contract documents; the mood, Phase 1A, and Phase 1B review surfaces; the four repaired browser-decode samples; and the seven-file Phase 2 landscape runtime.
...
The entity movement, production/rally, combat, AI, determinism, performance, physical-device, and network scenarios live in [`../docs/REDESIGN.md`](../docs/REDESIGN.md). They become active only in their approved phases. Phase 2 establishes only the landscape shell, camera, empty layered map, and their evidence gate; cross-network multiplayer remains unimplemented and untested.
