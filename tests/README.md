...
3. Run `node .github/scripts/stage-pages.js _site` and verify the exact 74-file stage: `.nojekyll` plus 73 explicitly allowlisted files comprising the status shell; public status/contract documents including the Phase 3 contract; the mood, Phase 1A, and Phase 1B review surfaces; the four repaired browser-decode samples; and the seven-file approved Phase 2 landscape runtime.
