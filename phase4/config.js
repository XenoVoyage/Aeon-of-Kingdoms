...
(function exposePhase4Configuration() {
  ...
  const configuration = deepFreeze({
    schemaVersion: 2,
    protocolVersion: 2,
    configurationId: "phase4-structures-economy-v1",
    playerCount: 2,
    tickRate: 20,
    tickDurationMs: 50,
    positionScale: 100,
  ...
  const structureCategories = deepFreeze([
    "headquarters",
    "resource-point",
    "production-outpost"
  ]);

  const captureRadiusWorld = deepFreeze({
    "resource-point": 112,
  ...
  else window.AeonPhase4Config = api;
}());
