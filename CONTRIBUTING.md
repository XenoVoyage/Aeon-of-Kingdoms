...
4. Treat [`docs/GAME_DESIGN.md`](docs/GAME_DESIGN.md), [`docs/ARCHITECTURE.md`](docs/ARCHITECTURE.md), and [`docs/ASSETS.md`](docs/ASSETS.md) as prototype-era records until their approved redesign phases replace them; use [`tests/README.md`](tests/README.md) for the active verification boundary.
...
The transition page needs no installation or build. Node.js 20 or newer is used only for local and continuous verification. A successful local check does not establish a Pages deployment or release.
