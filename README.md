...
[![Status build v2026.8.22d](https://img.shields.io/badge/status_build-v2026.8.22d-6ef3ff)](CHANGELOG.md)
...
## Phase 4 approved · Phase 5 combat authorized

[Play the approved Phase 4 foundation](phase4/) · [Read the frozen Phase 5 combat contract](docs/PHASE5_COMBAT_TACTICS.md) · [Read the closed Phase 4 contract](docs/PHASE4_STRUCTURES_ECONOMY.md)
...
- [Frozen Phase 5 combat and tactical-command contract](docs/PHASE5_COMBAT_TACTICS.md)
