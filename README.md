...
[![Status build v2026.8.22h](https://img.shields.io/badge/status_build-v2026.8.22h-6ef3ff)](CHANGELOG.md)
...
## Phase 6 approved · Phase 7 planning contract active

[Play the approved Phase 6 Standard local skirmish](phase6/) · [Read the Phase 6 closure evidence](docs/PHASE6_STRATEGIC_AI.md) · [Read the active Phase 7 contract](docs/PHASE7_PRODUCT_HARDENING.md)
...
- [Active Phase 7 product-hardening planning contract](docs/PHASE7_PRODUCT_HARDENING.md)
