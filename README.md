...
[![Status build v2026.8.22](https://img.shields.io/badge/status_build-v2026.8.22-6ef3ff)](CHANGELOG.md)
...
## Phase 3 entity and movement foundation — authorized

[Review the approved Phase 2 foundation](phase2/) · [Read the exact Phase 3 contract](docs/PHASE3_ENTITY_MOVEMENT.md) · [Review the approved Phase 1B target](https://xenovoyage.github.io/Aeon-of-Kingdoms/concepts/phase1b/)
...
- [Authorized Phase 3 entity and movement contract](docs/PHASE3_ENTITY_MOVEMENT.md)
