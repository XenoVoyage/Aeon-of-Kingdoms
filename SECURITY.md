...
- unbounded or unsafe Phase 2 through Phase 4 pointer, touch, keyboard, lifecycle, local-resource loading, Canvas sizing, map-data, command, simulation, snapshot, replay, checksum, queue, spawn, rally, capture, or art-loader processing;
