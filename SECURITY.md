...
- unbounded or unsafe Phase 2 through Phase 7 pointer, touch, keyboard, focus, lifecycle, fullscreen/orientation, local-resource loading, Canvas sizing, map-data, observation, planning, command, simulation, snapshot, replay, checkpoint, checksum, queue, spawn, rally, capture, combat, art-loader, or teardown processing;
