...
Phase 0 and the roadmap baseline were approved by the product owner on 2026-08-15. The active source candidate is the non-playable `v2026.8.15a` redesign status page. That approval authorizes the truth-and-cleanup transition only; it does not approve Phase 1 visuals, later gameplay work, a deployment, a tag, or a release without their own gates.
